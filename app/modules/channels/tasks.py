...
def sync_dynamic_playlist_task(self, playlist_id):
    ...
    from app.modules.playlists.models import PlaylistProfile, DiscoveryChannel
    ...
    try:
        ...
        status_state = ScannerStatus.get_singleton(db)
        ...
        db.query(DiscoveryChannel).filter_by(playlist_id=playlist_id).delete()
        db.commit()
