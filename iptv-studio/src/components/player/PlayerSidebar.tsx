...
export const PlayerSidebar: React.FC<PlayerSidebarProps> = ({ 
  ...
  return (
    <div className={`w-full lg:w-80 h-[50vh] lg:h-full flex flex-col bg-slate-950/80 backdrop-blur-3xl border-t lg:border-t-0 lg:border-r border-white/5 overflow-hidden animate-in fade-in lg:slide-in-from-left duration-500 shadow-2xl z-20 ${className}`}>
      {/* Search & Select */}
